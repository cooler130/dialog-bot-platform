...
@Service("policyProcessJsonService")
public class PolicyProcessJsonServiceImpl implements PolicyProcessService {

    private Logger logger = LoggerFactory.getLogger(PolicyProcessJsonServiceImpl.class);

    @Qualifier("jsonPolicyService")
    @Autowired
    private PolicyService policyService;

    @Qualifier("jsonConditionKVService")
    @Autowired
    private ConditionKVService conditionKVService;

    @Qualifier("jsonActionService")
    @Autowired
