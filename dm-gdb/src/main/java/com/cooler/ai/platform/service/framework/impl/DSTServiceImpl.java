...
public class DSTServiceImpl implements DSTService {
    ...
    public void fsmDSTProcess(DialogState dialogState) {
        ...
        logger.info("DST Running      : [ {}-({}轮), {}-({}轮) ] --- [ {} ] + ( {} ) ... ", domainName, dialogState.getDomainTurnNum(), taskName, dialogState.getDomainTaskTurnNum(),  currentState, intentName);
    ...
    private String transformStandardIntent(String domainName, String taskName, String currentState, String intentName) {
        TransformRelation transformRelation = transformRelationService.selectTransformIntent(domainName, taskName, currentState, intentName);
