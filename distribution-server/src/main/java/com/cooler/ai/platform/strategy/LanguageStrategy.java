        ...
        for (String domainName : domainNames){
            try {
                ...
                if (code == 200) {
                    ...
                    logger.error("请求 {} 返回码： {} ，入参 sentence ：{}, domainName : {} ,返回信息：{} 。", nluUrl, code, sentence, domainName, message);
                }
            } catch (Exception e) {
                logger.error("请求 {} 失败，入参 sentence ：{}, domainName : {}。", nluUrl, sentence, domainName, e);
            }
        }
